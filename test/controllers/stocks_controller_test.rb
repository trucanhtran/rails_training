...
class StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock" do
    assert_difference('Stock.count') do
      post stocks_url, params: { stock: { description: @stock.description, name: @stock.name } }
    end
  ...
  test "should update stock" do
    patch stock_url(@stock), params: { stock: { description: @stock.description, name: @stock.name } }
