...
class AppoinmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appoinment" do
    assert_difference('Appoinment.count') do
      post appoinments_url, params: { appoinment: { date: @appoinment.date, room: @appoinment.room } }
    end
  ...
  test "should update appoinment" do
    patch appoinment_url(@appoinment), params: { appoinment: { date: @appoinment.date, room: @appoinment.room } }
