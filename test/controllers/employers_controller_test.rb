...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { address: @employer.address, age: @employer.age, name: @employer.name, phone: @employer.phone } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { address: @employer.address, age: @employer.age, name: @employer.name, phone: @employer.phone } }
