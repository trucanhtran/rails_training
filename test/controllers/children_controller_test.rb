...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { age: @child.age, color: @child.color, name: @child.name } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { age: @child.age, color: @child.color, name: @child.name } }
