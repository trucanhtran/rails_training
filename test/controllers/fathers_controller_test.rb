...
class FathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create father" do
    assert_difference('Father.count') do
      post fathers_url, params: { father: { age: @father.age, description: @father.description, name: @father.name } }
    end
  ...
  test "should update father" do
    patch father_url(@father), params: { father: { age: @father.age, description: @father.description, name: @father.name } }
